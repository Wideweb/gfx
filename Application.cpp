...
Application::Application() {
    ...
    m_Window->setEventCallback(std::bind(&Application::onMouseEvent, this, std::placeholders::_1));
    
    m_Render = std::unique_ptr<InterpolatedTriangleRender>(new InterpolatedTriangleRender(m_Canvas));
}
